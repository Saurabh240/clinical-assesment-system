      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        {followUps.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm border border-emerald-100 p-8 sm:p-16 text-center">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">No Follow-ups Scheduled</h3>
            <p className="text-sm sm:text-base text-gray-600">There are currently no follow-ups to display.</p>
          </div>
        ) : (
          <>
            {/* Desktop Table View */}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-700">
                      ...
                      of <span className="font-semibold text-emerald-700">{followUps.length}</span> results
                    </p>
                  </div>
                  <div>
  ...
  >
              ...
              <div className="bg-white rounded-xl shadow-sm border border-emerald-100 p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <p className="text-xs text-gray-600">
                    <span className="font-semibold text-emerald-700">{followUps.length}</span> total
                  </p>
                </div>
